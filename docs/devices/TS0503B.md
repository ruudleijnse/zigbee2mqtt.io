...
- For Zigbee connection mode, hold the button for 6 seconds. The LED strip will blink once to confirm. To reset the controller completely, hold for 10 seconds until the LED strip flashes a second time.
